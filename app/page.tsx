      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-2">Run Simulations</h3>
            <p className="text-slate-600">Lightweight models with multiple scenarios and outcomes</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-2">Compare Outcomes</h3>
            <p className="text-slate-600">Side-by-side analysis with equity and sentiment insights</p>
          </div>
        </div>
      </div>
    </div>
