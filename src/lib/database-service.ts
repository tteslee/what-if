...
export class DatabaseService {
  ...
  private transformCityFromDB(dbCity: Record<string, unknown>): CityProfile {
    return {
      ...
      populationContext: dbCity.population_context as any,
      ...
      demographics: dbCity.demographics as any,
      mobility: dbCity.mobility as any,
      housing: dbCity.housing as any,
      environment: dbCity.environment as any,
      health: dbCity.health as any,
      economy: dbCity.economy as any,
      socialGovernance: dbCity.social_governance as any,
      fiscal: dbCity.fiscal as any,
      dataQuality: dbCity.data_quality as any,
      implementationReadiness: dbCity.implementation_readiness as any,
      customIndicators: dbCity.custom_indicators as any,
    };
  }
  ...
  private transformInterventionFromDB(dbIntervention: Record<string, unknown>): Intervention {
    return {
      ...
      parameters: dbIntervention.parameters as any,
      ...
      params: dbIntervention.params as any,
      mechanisms: dbIntervention.mechanisms as any,
      implementation: dbIntervention.implementation as any,
      assumptions: dbIntervention.assumptions as string[] | undefined,
      subInterventions: dbIntervention.sub_interventions as any,
    };
  }
  ...
  private transformScenarioResultFromDB(dbResult: Record<string, unknown>): ScenarioResult {
    return {
      ...
      stakeholderImpacts: dbResult.stakeholder_impacts as any,
      systemEffects: dbResult.system_effects as any,
      policyInteractions: dbResult.policy_interactions as any,
      risks: dbResult.risks as any,
      assumptions: dbResult.assumptions as any,
      signals: dbResult.signals as any,
      experiments: dbResult.experiments as any,
