export const ko = {
  ...
  // City Form
  cityForm: {
    createCustomCity: '사용자 정의 도시 생성',
    fillRequiredFields: '새 도시 프로필을 생성하려면 필수 필드를 작성하세요.',
    name: '도시 이름',
    scale: '도시 규모',
    citywide: '도시 전체',
    districtNeighbourhood: '구역/동네',
    corridorStreet: '회랑/거리',
    specificSite: '특정 부지',
    mainChallenges: '주요 과제',
    addChallenge: '과제 추가',
    showOptional: '선택 사항 보기',
    hideOptional: '선택 사항 숨기기',
    populationContext: '인구 맥락 (선택 사항)',
    populationSize: '인구 규모',
    demographics: '인구 통계',
    neighbourhoodCharacteristics: '동네 특성 (선택 사항)',
    vulnerableGroups: '취약 또는 우선 그룹 (선택 사항)',
    addVulnerableGroup: '취약 그룹 추가',
    regulatoryContext: '규제 맥락 (선택 사항)',
    timeline: '타임라인 (선택 사항)',
    budgetConstraints: '예산 제약 (선택 사항)',
    existingAssets: '기존 자산 (선택 사항)',
  ...
  // Intervention Form
  interventionForm: {
    createCustomIntervention: '사용자 정의 솔루션 생성',
    ...
    synergies: '시너지 (선택 사항)',
    addSynergy: '시너지 추가',
    intendedOutcomes: '의도된 결과 (선택 사항)',
    addIntendedOutcome: '의도된 결과 추가',
    stakeholderFocus: '이해관계자 초점 (선택 사항)',
    addStakeholder: '이해관계자 추가',
    implementationNotes: '구현 참고 사항 (선택 사항)',
    risks: '위험 (선택 사항)',
    addRisk: '위험 추가',
    showOptional: '선택 사항 보기',
    hideOptional: '선택 사항 숨기기',
