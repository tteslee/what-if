export const ko = {
  ...
  main: {
    title: 'What-if',
    subtitle: '당신의 도시의 미래를 탐험하세요',
    description: '"만약에" 질문을 던지고 다양한 개입이 도시 환경을 어떻게 변화시킬 수 있는지 발견해보세요.',
  ...
  scenario: {
    steps: {
      ...
      city: {
        ...
        createCustomDescription: '폼을 작성하여 자신만의 도시 프로필을 만드세요',
      },
      interventions: {
        title: '개입 선택',
        description: '무엇을 테스트하고 싶으신가요?',
        createCustom: '맞춤 개입 만들기',
        createCustomDescription: '폼을 작성하여 자신만의 개입 프로필을 만드세요',
        selected: '선택된 개입',
        available: '사용 가능한 개입',
      },
      review: {
